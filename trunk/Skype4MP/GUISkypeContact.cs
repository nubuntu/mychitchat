...
namespace maniac.MediaPortal.Skype
{
  ...
  /// </summary>
  public class GUISkypeContact : GUIWindow, IRenderLayer
  {
    #region CONST
    public static int WINDOW_ID = 1912;
    ...
    public void DoModal(int dwParentId, SKYPE4COMLib.User Friend)
    {
